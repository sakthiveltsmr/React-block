  ...
  return (
    <>
      <div className="container">
        ...
        <div className="modal fade bg-primary" id="mymodal">
            ...
            return (
              ...
              >
                ...
                <div className="card-footer row">
                  <button
                    className="btn btn-outline-danger col-lg-3 my-2 mx-auto"
                    data-toggle="modal"
                  ...
                  <button
                    className="btn btn-outline-success col-lg-3 my-2 mx-auto"
                    data-toggle="modal"
                    data-target="#mymodal"
                  ...
                  <Link
                    to={`/posts/${post.id}`}
                    className="btn col-lg-3 my-2 btn-outline-warning mx-auto"
                  >
                    Comments
                  </Link>
                </div>
